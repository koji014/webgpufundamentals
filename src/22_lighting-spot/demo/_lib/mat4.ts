...
export const mat4 = {
  copy(src: Float32Array, dst?: Float32Array) {
  ...
  aim(eye: Vec, target: Vec, up: Vec, dst?: Float32Array) {
    dst = dst || new Float32Array(16);
  ...
  cameraAim(eye: Vec, target: Vec, up: Vec, dst?: Float32Array) {
    dst = dst || new Float32Array(16);
  ...
  lookAt(eye: Vec, target: Vec, up: Vec, dst?: Float32Array) {
    return mat4.inverse(mat4.cameraAim(eye, target, up, dst), dst);
  },

  translation([tx, ty, tz]: Vec, dst?: Float32Array) {
    dst = dst || new Float32Array(16);
    // biome-ignore format: _
    dst.set([
      1,  0,  0,  0,
  ...
  scaling([sx, sy, sz]: Vec, dst?: Float32Array) {
    dst = dst || new Float32Array(16);
    // biome-ignore format: _
    dst.set([
      sx, 0,  0,  0,
  ...
  translate(m: Float32Array, translation: Vec, dst?: Float32Array) {
  ...
  scale(m: Float32Array, scale: Vec, dst?: Float32Array) {
