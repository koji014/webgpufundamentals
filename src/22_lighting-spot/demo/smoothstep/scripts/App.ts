...
export class App {
  ...
  private readonly shininessValue: Float32Array<ArrayBuffer>;
  private readonly lightDirectionValue: Float32Array<ArrayBuffer>;
  private readonly innerLimitValue: Float32Array<ArrayBuffer>;
  private readonly outerLimitValue: Float32Array<ArrayBuffer>;
  ...
  private constructor(fields: {
    ...
    shininessValue: Float32Array<ArrayBuffer>;
    lightDirectionValue: Float32Array<ArrayBuffer>;
    innerLimitValue: Float32Array<ArrayBuffer>;
    outerLimitValue: Float32Array<ArrayBuffer>;
    ...
    this.shininessValue = fields.shininessValue;
    this.lightDirectionValue = fields.lightDirectionValue;
    this.innerLimitValue = fields.innerLimitValue;
    this.outerLimitValue = fields.outerLimitValue;
  ...
  static async create(canvas: HTMLCanvasElement): Promise<App> {
    ...
    // normalMatrix(12) + worldViewProjection + world + color + lightWorldPosition
    //   + viewWorldPosition + shininess + lightDirection + innerLimit + outerLimit
    ...
    const settings: Settings = {
      ...
      shininess: 30,
      innerLimit: App.degToRad(15),
      outerLimit: App.degToRad(25),
      aimOffsetX: -10,
      aimOffsetY: 10,
    };
  ...
  private render() {
...

    {
      const mat = mat4.aim(
        ...
        [
          App.kTarget[0] + this.settings.aimOffsetX,
          App.kTarget[1] + this.settings.aimOffsetY,
          0,
        ],
        App.kUp,
      );
