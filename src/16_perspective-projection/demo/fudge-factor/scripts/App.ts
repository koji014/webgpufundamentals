...
export class App {
  ...
  private readonly fudgeFactorValue: Float32Array<ArrayBuffer>;
  ...
  private constructor(fields: {
    ...
    fudgeFactorValue: Float32Array<ArrayBuffer>;
    ...
    this.fudgeFactorValue = fields.fudgeFactorValue;
  ...
  static async create(canvas: HTMLCanvasElement): Promise<App> {
    ...
    const fudgeFactorValue = uniformValues.subarray(
      kFudgeFactorOffset,
      kFudgeFactorOffset + 1,
    );
  ...
  private render() {
    ...
    this.fudgeFactorValue[0] = this.settings.fudgeFactor;
